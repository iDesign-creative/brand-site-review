...
(function () {
  ...
  function STYLES() { return [
    ...
    ':host{--surf:#002E40;--surf2:#123E4E;--field:#00293A;--line:#20505F;--primary:#33C9FF;--primary2:#5CD4FF;--green:#81C784;--text:#E9F3F7;--muted:#8FA8B4}',
    ...
    '.idr-pin{position:fixed;transform:translate(-50%,-50%);width:28px;height:28px;border-radius:50% 50% 50% 3px;background:var(--primary);color:#00202D;border:2px solid #E9F3F7;font-size:12px;font-weight:700;cursor:pointer;pointer-events:auto;box-shadow:0 3px 10px rgba(0,10,20,.5);display:flex;align-items:center;justify-content:center}',
    ...
    '.idr-panel{position:fixed;top:16px;right:16px;width:322px;max-height:calc(100vh - 32px);max-height:calc(100dvh - 32px);background:linear-gradient(90deg,rgba(1,80,110,.97) 0%,rgba(0,51,70,.97) 100%);border:1px solid #4DA5C6;border-radius:0 16px 0 16px;box-shadow:0 16px 50px rgba(0,10,20,.55);pointer-events:auto;display:flex;flex-direction:column;overflow:hidden;color:var(--text)}',
    '.idr-collapsed{width:auto;background:transparent;box-shadow:none;border:none}',
    '.idr-fab{pointer-events:auto;background:var(--primary);color:#00202D;border:none;border-radius:24px;padding:12px 20px;font-weight:700;font-size:14px;cursor:pointer;box-shadow:0 6px 22px rgba(1,127,174,.5)}',
    ...
    '.idr-add{margin:12px 14px 6px;padding:12px;border:none;border-radius:24px;background:var(--primary);color:#00202D;font-weight:700;font-size:14px;cursor:pointer}',
    ...
    '.idr-tab.on{background:#D6F4FF;color:#002E40}',
    ...
    '.idr-badge{flex:none;width:22px;height:22px;border-radius:50%;background:var(--primary);color:#00202D;font-size:11px;font-weight:700;display:flex;align-items:center;justify-content:center}',
    ...
    '.idr-pop{position:fixed;width:324px;background:linear-gradient(90deg,rgba(1,80,110,.97) 0%,rgba(0,51,70,.97) 100%);border:1px solid #4DA5C6;border-radius:0 16px 0 16px;box-shadow:0 16px 50px rgba(0,10,20,.6);padding:14px;pointer-events:auto;color:var(--text);z-index:20}',
    ...
    '.idr-btn{background:var(--primary);color:#00202D;border:none;border-radius:24px;padding:9px 20px;font-weight:700;font-size:13px;cursor:pointer}',
    ...
    '.idr-gate{width:380px;max-width:calc(100vw - 40px);background:linear-gradient(90deg,rgba(1,80,110,.97) 0%,rgba(0,51,70,.97) 100%);border:1px solid #4DA5C6;border-radius:0 16px 0 16px;box-shadow:0 30px 80px rgba(0,8,16,.75);padding:26px 24px}',
    ...
    '.idr-selchip{position:fixed;z-index:36;background:var(--primary);color:#00202D;border:none;border-radius:9px;padding:8px 13px;font-size:12.5px;font-weight:700;cursor:pointer;pointer-events:auto;box-shadow:0 6px 18px rgba(1,127,174,.5);white-space:nowrap}',
